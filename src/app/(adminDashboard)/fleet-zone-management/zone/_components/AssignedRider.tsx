...
export default function AssignedRider() {
        ...
        <div className='bg-section-bg rounded-3xl border border-[#d7d4ef]/50'>
            <div className="flex items-center justify-between  mb-4 mt-2 pt-2 mx-5">
                <div className="space-y-1">
                    <h3 className="md:text-3xl text-2xl font-medium">Assigned Riders</h3>
                    <p className="text-[#727272]">6 rider assigned to Uptown Zone</p>
                </div>
                <div>
